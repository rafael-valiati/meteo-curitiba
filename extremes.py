...
if daily_data.empty:
    ...
    quadrado = plt.Rectangle((0.2, 0.2), 0.1, 0.45, transform=fig.transFigure, color='black', lw=0, edgecolor='black', facecolor='none')
    fig.patches.append(quadrado)
    quadrado = plt.Rectangle((0.6, 0.2), 0.1, 0.45, transform=fig.transFigure, color='black', lw=0, edgecolor='black', facecolor='none')
    fig.patches.append(quadrado)
